...
function addStyleToDesktopPopUp() {
  ...
  bigProject1.macbookMaximized.style.backgroundImage = 'linear-gradient(90deg, rgba(0, 0, 0, 0.15) 0%, rgba(0, 0, 0, 0) 5.21%, rgba(0, 0, 0, 0) 92.16%, rgba(0, 0, 0, 0.15) 100%)';
  bigProject1.macbookMaximized.style.backgroundImage = "url('assets/Mobile-dynamic/Rectangle 34.png')";
  ...
  bigProject1.macbookMinimized.style.backgroundImage = "url('assets/Mobile-dynamic/Rectangle 39.png')";
  bigProject1.macbookMinimized.style.backgroundRepeat = 'repeat';

  imgContainerLeftArrow.style.backgroundImage = "url('assets/Mobile-dynamic/Vector 5.png')";
  ...
  imgContainerRightArrow.style.backgroundImage = "url('assets/Mobile-dynamic/Vector 4.png')";
  ...
  addLiveLink.style.backgroundImage = "url('assets/Mobile-dynamic/ic_link.png')";
  ...
  addGithubLink.style.backgroundImage = "url('assets/Mobile-dynamic/ic_github_white.svg')";
  ...
  leftArrow.style.backgroundImage = "url('assets/Mobile-dynamic/ic_arrow_left.svg')";
  ...
  rightArrow.style.backgroundImage = "url('assets/Mobile-dynamic/ic_arrow_right.svg')";
...
myFirstProjectBtn.addEventListener('click', () => {
  removeElements();
  ...
  rectBar.addEventListener('click', () => {
    const headerDesktop = document.querySelector('.desktop-version');
...
mySecondProjectBtn.addEventListener('click', () => {
  removeElements();
  addStyleToDesktopPopUp();
